...
export default async function SchoolAdminLayout({
      ...
      <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-6">
        <div className="max-w-md w-full p-8 rounded-3xl bg-card border border-destructive/30 shadow-2xl text-center space-y-4">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            The School Administrator portal is strictly restricted to accounts with the <strong className="text-foreground">ADMIN</strong> role. Your current account role is <span className="font-mono font-bold text-primary">{user.role}</span>.
          </p>
          <div className="pt-2">
            <Link
              href="/dashboard"
    ...
    return (
      <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-6">
        <div className="max-w-md w-full p-8 rounded-3xl bg-card border border-amber-500/30 shadow-2xl text-center space-y-4">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            This administrator account is not linked to any active school tenant in the database. Please contact your platform administrator.
          </p>
          <div className="pt-2">
            <Link
              href="/dashboard"
    ...
    return (
      <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-6">
        <div className="max-w-md w-full p-8 rounded-3xl bg-card border border-destructive/30 shadow-2xl text-center space-y-4">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            The school institution record associated with this account has been archived or deleted.
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-6">
        <div className="max-w-md w-full p-8 rounded-3xl bg-card border border-amber-500/30 shadow-2xl text-center space-y-4">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            Access to <strong className="text-foreground">{schoolDoc.name}</strong> has been temporarily suspended by the platform administrator. Please contact system support.
          </p>
        </div>
      </div>
    );
  ...
  // 5. Render standard School Admin shell
  return (
    <AdminLayoutShell
