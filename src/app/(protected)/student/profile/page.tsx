  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
        ...
        <p className="text-sm text-zinc-400 font-medium">Loading profile information...</p>
      </div>
    );
  }
    ...
    <div className="space-y-8 pb-12 max-w-5xl mx-auto">
      ...
      <div className="p-6 rounded-3xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-xl">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-lg font-bold text-white">Academic Placement</h2>
            <p className="text-xs text-zinc-400">Institutional records managed by School Administration</p>
          </div>
        </div>

        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          <div className="p-4 rounded-2xl bg-zinc-950/60 border border-zinc-800/80">
            <span className="text-xs text-zinc-400 block mb-1">Admission Number</span>
            <span className="text-sm font-bold text-white">{student.admissionNumber}</span>
          </div>
          <div className="p-4 rounded-2xl bg-zinc-950/60 border border-zinc-800/80">
            <span className="text-xs text-zinc-400 block mb-1">Student ID</span>
            <span className="text-sm font-bold text-white">{student.studentId || "N/A"}</span>
          </div>
          <div className="p-4 rounded-2xl bg-zinc-950/60 border border-zinc-800/80">
            <span className="text-xs text-zinc-400 block mb-1">Class & Section</span>
            <span className="text-sm font-bold text-emerald-400">
              Class {academic.class.name} - {academic.section.name}
            </span>
          </div>
          <div className="p-4 rounded-2xl bg-zinc-950/60 border border-zinc-800/80">
            <span className="text-xs text-zinc-400 block mb-1">Roll Number</span>
            <span className="text-sm font-bold text-white">{student.rollNumber || "N/A"}</span>
          </div>
          <div className="p-4 rounded-2xl bg-zinc-950/60 border border-zinc-800/80">
            <span className="text-xs text-zinc-400 block mb-1">Academic Year</span>
            <span className="text-sm font-bold text-zinc-200">{academic.academicYear.name}</span>
          </div>
          <div className="p-4 rounded-2xl bg-zinc-950/60 border border-zinc-800/80">
            <span className="text-xs text-zinc-400 block mb-1">Gender</span>
            <span className="text-sm font-bold text-zinc-200">{student.gender}</span>
          </div>
          <div className="p-4 rounded-2xl bg-zinc-950/60 border border-zinc-800/80">
            <span className="text-xs text-zinc-400 block mb-1">Admission Date</span>
            <span className="text-sm font-bold text-zinc-200">
              {new Date(student.admissionDate).toLocaleDateString()}
            </span>
          </div>
          <div className="p-4 rounded-2xl bg-zinc-950/60 border border-zinc-800/80">
            <span className="text-xs text-zinc-400 block mb-1">Institution</span>
            <span className="text-sm font-bold text-zinc-200">{school.name}</span>
          </div>
        </div>
      </div>
        ...
        <div className="p-6 rounded-3xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-xl">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-400">Update your allowed personal & contact details</p>
              </div>
            </div>
            <button
              type="submit"
              disabled={saving}
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-medium transition shadow-lg disabled:opacity-50"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-zinc-950/80 border border-zinc-800 text-white text-sm focus:outline-none focus:border-emerald-500 transition"
              />
            </div>

            <div>
              <label className="block text-xs font-medium text-zinc-300 mb-2">Date of Birth</label>
              <input
                type="date"
            ...
            <div>
              <label className="block text-xs font-medium text-zinc-300 mb-2">Blood Group</label>
              <input
                type="text"
            ...
            <div className="md:col-span-3">
              <label className="block text-xs font-medium text-zinc-300 mb-2">Avatar URL</label>
              <input
                type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="md:col-span-3">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-xl bg-zinc-950/80 border border-zinc-800 text-white text-sm focus:outline-none focus:border-emerald-500"
                />
              </div>
              <div>
              ...
              <div>
                <label className="block text-xs font-medium text-zinc-400 mb-1.5">Postal Code</label>
                <input
                  type="text"
          ...
          <div className="mt-8 pt-6 border-t border-zinc-800/80">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-xs font-medium text-zinc-400 mb-1.5">Relationship</label>
                <input
                  type="text"
          ...
          <div className="mt-8 pt-6 border-t border-zinc-800/80">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-xs font-medium text-zinc-400 mb-1.5">Allergies (comma separated)</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-medium text-zinc-400 mb-1.5">Conditions</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-medium text-zinc-400 mb-1.5">Medications</label>
                <input
                  type="text"
              ...
              <div className="md:col-span-3">
                <label className="block text-xs font-medium text-zinc-400 mb-1.5">Medical Notes</label>
                <textarea
                  rows={2}
      ...
      <div className="p-6 rounded-3xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-xl">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-lg font-bold text-white">Linked Parents & Guardians</h2>
            <p className="text-xs text-zinc-400">Authorized guardians registered with the school</p>
          </div>
        </div>

        {parents.length === 0 ? (
          <div className="py-8 text-center rounded-2xl bg-zinc-950/40 border border-dashed border-zinc-800">
            <Users className="w-6 h-6 text-zinc-600 mx-auto mb-1.5" />
            <p className="text-xs font-medium text-zinc-400">No parent records linked.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {parents.map((p) => (
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mt-4 pt-3 border-t border-zinc-800/60 text-[11px]">
                  {p.isPrimaryGuardian && (
      ...
      <div className="p-6 rounded-3xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-xl">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400">Change your portal password</p>
          </div>
        </div>

        {passwordSuccess && (
          <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-sm flex items-center gap-3 mb-6">
            <CheckCircle2 className="w-5 h-5 shrink-0" />
            <span>{passwordSuccess}</span>
          </div>
        )}
        {passwordError && (
          <div className="p-4 rounded-2xl bg-red-500/10 border border-red-500/30 text-red-400 text-sm flex items-center gap-3 mb-6">
            <AlertCircle className="w-5 h-5 shrink-0" />
        ...
        <form onSubmit={handlePasswordSubmit} className="space-y-4 max-w-lg">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-zinc-950/80 border border-zinc-800 text-white text-sm focus:outline-none focus:border-amber-500"
            />
          </div>
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-amber-600 hover:bg-amber-500 text-white text-sm font-medium transition shadow-lg disabled:opacity-50 mt-2"
          >
